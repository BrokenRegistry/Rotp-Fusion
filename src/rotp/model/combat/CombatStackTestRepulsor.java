...
public class CombatStackTestRepulsor extends CombatStackMonster {
	public CombatStackTestRepulsor(SpaceMonster fl, String imageKey, Float level, int desId, boolean isFusion, Color shieldC) {
		super(fl, imageKey, level, desId, isFusion, shieldC);
}
	...
	@Override public float maxMove()			{ return 0; }
	@Override public boolean immuneToStasis()	{ return true; }
	@Override public void reloadWeapons()		{ reloadComponents(); };
