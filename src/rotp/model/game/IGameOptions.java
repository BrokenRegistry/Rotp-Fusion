...
public interface IGameOptions extends IModOptions {
    ...
    public static final int PLAYER		= 12;	// Not a selectable AI
    // Base AI Entries
...
//    AIEntry offAI		  = new AIEntry(FUSION,					AUTOPLAY_OFF,				AUTOPLAY_OFF);
    AIEntry offAI		  = new AIEntry(PLAYER,					AUTOPLAY_OFF,				AUTOPLAY_OFF);
    AIEntry baseAI		  = new AIEntry(BASE,					AUTOPLAY_AI_BASE,			OPPONENT_AI_BASE);		// Base
    AIEntry modnarAI	  = new AIEntry(MODNAR,					AUTOPLAY_AI_MODNAR,			OPPONENT_AI_MODNAR);	// Modnar
    AIEntry rookieAI	  = new AIEntry(ROOKIE,					AUTOPLAY_AI_ROOKIE,			OPPONENT_AI_ROOKIE);	// Rookie
    AIEntry xilmiAI		  = new AIEntry(XILMI, 					AUTOPLAY_AI_XILMI,			OPPONENT_AI_XILMI);		// Roleplay
    AIEntry hybridAI	  = new AIEntry(HYBRID,					AUTOPLAY_AI_HYBRID,			OPPONENT_AI_HYBRID);	// Hybrid
    AIEntry fusionAI	  = new AIEntry(FUSION, 				AUTOPLAY_AI_CRUEL,			OPPONENT_AI_CRUEL);		// Fusion
    AIEntry funAI		  = new AIEntry(FUN,					AUTOPLAY_AI_FUN,			OPPONENT_AI_FUN);		// Fun
    AIEntry personalityAI = new AIEntry(PERSONALITY,			AUTOPLAY_AI_PERSONALITY,	OPPONENT_AI_PERSONALITY);	// Character
