...
public final class SettingsWidgetSprite extends MapControlSprite {
	private BufferedImage image;
	private BufferedImage image() {
		if (image == null)
			image = settingsIcon(width, height, s12);
		return image;
	}
	public SettingsWidgetSprite(int xOff, int yOff, int w, int h)	{ super(xOff, yOff, w, h, "SETTINGS_MOD_SETTINGS_OPTIONS_UI_DESC"); }
	@Override
