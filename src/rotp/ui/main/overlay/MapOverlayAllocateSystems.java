...
public final class MapOverlayAllocateSystems implements IMapOverlay {
    ...
    public void init(HashMap<StarSystem,List<String>> newSystems) {
        drawSprites = true;
        // BR: remove null if any... Should not happen, but it happen!!!
        ...
        parent.hoveringOverSprite(null, true);
...
final class PreviousSystemButtonSprite extends RoundButtonSprite {
	...
	public void init(MapOverlayAllocateSystems p, Graphics2D g)	{ init(p, g, s20, s30, "MAIN_ALLOCATE_PREV_SYSTEM"); }
...
final class NextSystemButtonSprite extends RoundButtonSprite {
	...
	public void init(MapOverlayAllocateSystems p, Graphics2D g)	{ init(p, g, s20, s30, "MAIN_ALLOCATE_NEXT_SYSTEM"); }
...
final class ContinueButtonSprite extends RoundButtonSprite {
	...
	public void init(MapOverlayAllocateSystems p, Graphics2D g)	{ init(p, g, s60, s30, "MAIN_ALLOCATE_CLOSE"); }
